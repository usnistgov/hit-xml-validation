...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" xmlns:sdtc="urn:hl7-org:sdtc">
...
<!--                    <xsl:value-of select="n1:assignedAuthoringDevice/n1:softwareName"/>-->
                  ...
                  <xsl:when test="n1:representedOrganization">
                    <xsl:call-template name="show-code">
                      <xsl:with-param name="code" select="n1:representedOrganization/n1:name"/>
                    </xsl:call-template>
                  </xsl:when>
                  <xsl:otherwise>
            ...
            <div class="col-md-8">
              ...
              <div class="header-group-content col-md-8">
                <div class="row">
                  ...
                  <xsl:if test="n1:patient/sdtc:deceasedTime">
                      <div class="row">
                          <div class="attribute-title col-md-4">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <xsl:choose>
                        ...
                        <xsl:if test="n1:patient/sdtc:ethnicGroupCode">
  ...
  <xsl:template
    ...
    <!-- SG: added this to try and get linkHtml to work -->
    <xsl:template
        match="n1:linkHtml">
        <xsl:element name="a">
